...
class PdfQA:
    ...
    def vector_db_pdf(self) -> None:
        ...
        if persist_directory and os.path.exists(persist_directory):
            ...
            text_splitter = TokenTextSplitter(chunk_size=500, chunk_overlap=10)  # This the encoding for text-embedding-ada-002
    ...
    def retreival_qa_chain(self):
        ...
        self.retriever = self.vectordb.as_retriever(search_kwargs={"score_threshold": .95,"k":1})
        ...
        if self.config["llm"] == LLM_OPENAI_GPT35:
          ...
          self.qa = RetrievalQA.from_chain_type(llm=OpenAI(model_name=LLM_OPENAI_GPT35, temperature=0.), chain_type="stuff",\
            ...
            self.qa = RetrievalQA.from_chain_type(llm=hf_llm, chain_type="stuff",retriever=self.retriever,return_source_documents=True)
